...
/**
 * Created by c.mark on 2015/10/19.
 */
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String convertTempToSystemUnit(double temp) {
        int units = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(mContext).
                getString(mContext.getString(R.string.settings_units_key), "1"));
